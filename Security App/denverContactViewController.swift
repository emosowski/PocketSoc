//
//  denverContactViewController.swift
//  Security App
//
...
class denverContactViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func officeCall(_ sender: Any) {
        let number = URL(string: "telprompt://3038985417")!
