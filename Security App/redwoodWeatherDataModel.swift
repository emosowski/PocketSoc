...
class redwoodWeatherDataModel {
    ...
    let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?q=RedwoodCity&appid=cc0f2053f612b7d277bde4fecd2861c3")!
