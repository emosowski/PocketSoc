//
//  redwoodContactViewController.swift
//  Security App
//
...
class redwoodContactViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func officeCall(_ sender: Any) {
        ...
        let number = URL(string: "telprompt://6504642676")!
