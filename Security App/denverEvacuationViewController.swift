//
//  denverEvacuationViewController.swift
//  Security App
//
...
class denverEvacuationController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let pdf = Bundle.main.url(forResource: "DenverWelcomeKit", withExtension: "pdf", subdirectory: nil, localization: nil)  {
